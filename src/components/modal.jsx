...
function ModalWindow({open, handleClose, checkOrder, edit, getList, oldName, oldSurname, oldGender, oldBalance, oldHasCard }) {
    // debugger
    // const [save, setSave] = useState(false);
    const [newItem, setNewItem] = useState({});
    const [name, setName] = useState(oldName || "");
    const [surname, setSurname] = useState(oldSurname || "");
    const [gender, setGender] = useState(oldGender || "male");
    const [balance, setBalance] = useState(oldBalance || 0);
    const [hasCard, setHasCard] = useState(oldHasCard || false);
